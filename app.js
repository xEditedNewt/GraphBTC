...
async function printBnbChart() {
  ...
  let bnbChart = await document.getElementById('bnbChart').getContext('2d');
  
  let gradient = await bnbChart.createLinearGradient(0, 0, 0, 400);
  ...
  bnbChartChart = new Chart(bnbChart, {
    type: 'line',
    data: {
      labels: times,
      datasets: [{
